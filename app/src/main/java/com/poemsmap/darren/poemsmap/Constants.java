...
public class Constants {
    ...
    public static final LatLng HEFEI = new LatLng(31.86, 117.27);// 合肥市经纬度
    public static final LatLng WUXI = new LatLng(31.568, 120.299);// 无锡市经纬度


    public static final LatLng LUSHAN = new LatLng(29.42, 116.26);// 庐山经纬度
    public static final LatLng JINLING = new LatLng(32.04, 118.78);// 金陵经纬度
    public static final LatLng DANYANG = new LatLng(32.00, 119.55);// 丹阳经纬度
    public static final LatLng JINLING1 = new LatLng(31.78, 119.95);// 常州晋陵经纬度
    public static final LatLng BOYANG = new LatLng(29.00, 116.67);// 鄱阳经纬度
    public static final LatLng XUNYANG = new LatLng(29.73, 115.98);// 浔阳经纬度
}
